...
class Kattis(commands.GroupCog, name="kattis"):
    ...
    async def load_data(self):
        ...
        with open("data/problems.json", "r", encoding="utf-8") as f:
            ...
            self.all_problems = (
                self.easy_problems + self.medium_problems + self.hard_problems
            )
    ...
    @app_commands.command(
        name="book", description="Get the url to a random google sheets document idk."
    )
    ...
    @app_commands.command(
        name="problem",
        description="Get a random kattis problem based on the chosen difficulty.",
    )
    ...
    @app_commands.command(
        name="by-category",
        description="Get a random kattis problem based on the chosen category.",
    )
